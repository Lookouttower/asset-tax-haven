...
const redeemAlpine = asset("alpine-retreats.jpeg");
const redeemForest = asset("forest-lookouts.jpeg");
const pjetV2 = asset("private-jet-fleet-v2.jpeg");
const beachVillasImg = asset("beach-villas.jpeg");
const glassHousesImg = asset("glass-houses.jpeg");
const pillarWriteoffAsset = asset("pillar-writeoff.jpeg");
const pillarReturnAsset = asset("pillar-return.jpeg");
const pillarTravelAsset = asset("pillar-travel.jpeg");
const pillarWriteoffV2 = asset("pillar-writeoff-v2.jpeg");
const pillarIncomeV2 = asset("pillar-income-v2.jpeg");
const pillarTravelV2 = asset("pillar-travel-v2.jpeg");
const pillar1Documents = asset("pillar-1-documents.jpg");
const pillar2Seal = asset("pillar-2-seal.jpg");
const pillar3Villa = asset("pillar-3-villa.jpg");
const asset1 = asset("asset-1.jpeg");
const asset2 = asset("asset-2.jpeg");
const asset3 = asset("asset-3.jpeg");
const asset4 = asset("asset-4.jpeg");
const asset5 = asset("asset-5.jpeg");
const asset6 = asset("asset-6.jpeg");
const asset7 = asset("asset-7.jpeg");
const yachtVandutch = asset("yacht-vandutch.jpg");
const asset8 = asset("asset-8.jpeg");
const asset9 = asset("asset-9.jpeg");
const asset10 = asset("asset-10.jpeg");
const asset11 = asset("asset-11.jpeg");
const asset12 = asset("asset-12.jpeg");
const asset14 = asset("asset-14.jpeg");
const asset15 = asset("asset-15.jpeg");
const asset16 = asset("asset-16.jpeg");
const asset17 = asset("asset-17.jpeg");
const asset18 = asset("asset-18.jpeg");
